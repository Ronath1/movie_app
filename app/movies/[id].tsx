    ...
    <View className="bg-primary flex-1">
        <ScrollView contentContainerStyle={{
            ...
            <View className="flex-row items-center gap-x-1 mt-2">
                ...
                <View className="flex-row items-center bg-dark-100 px-2
                ...
                <MovieInfo label="Production Companies"
                           value={movie?.production_companies.map((c) => c.name).
                           join(' - ') || 'N/A' } />
        ...
        flex-row items-center justify-center z-50" onPress={router.back}>
            ...
            mr-1 mt-0.5 rotate-180" tintColor="#fff"/>

            <Text className="text-white font font-semibold text-base">
                Go Back
            </Text>
        </TouchableOpacity>
       </View>
